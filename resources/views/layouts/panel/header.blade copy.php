<header class="flex-shrink-0 border-b bg-slate-100">
    <div class="flex items-center justify-between p-2">
        <!-- Navbar left -->
        <div class="flex items-center space-x-3">
            <span class="p-2 text-xl font-semibold tracking-wider uppercase lg:hidden">Satellite</span>
        ...
        <div class="relative flex items-center space-x-3">
            ...
            <div class="items-center hidden space-x-3 md:flex">
              ...
              <div>
                <button @click="darkMode = !darkMode" class="p-2 bg-gray-100 rounded-full hover:bg-gray-200 focus:outline-none focus:ring focus:ring-bg1">
            ...
            <div class="relative" x-data="{ isOpen: false }">
                ...
                <div @click.away="isOpen = false" x-show.transition.opacity="isOpen"
                    class=" absolute z-50 w-48 max-w-md mt-3 transform bg-white rounded-m shadow-lg -translate-x-3/4 min-w-max">
