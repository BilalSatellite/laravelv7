...
@section('title','Dashboard')
 ...
 <div class="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2 lg:grid-cols-4">
    <!-- Users chart card --><a href="#"
        class="bg-skin-contentbody-fill p-4 transition-shadow  rounded-lg shadow-sm hover:shadow-lg">
        <div class="flex items-start ">
            <div class="flex flex-col flex-shrink-0 space-y-2">
                <span class="text-skin-headline ">headline</span>
                <span class="text-skin-titel ">titel</span>
            </div>
        ...
        <div>
            <span class="inline-block px-2  text-skin-sub-titel ">sub-titel</span>
            <span class="text-skin-paragraph ">paragraph</span>
        </div>
    </a>
    ...
    <a href="#"
        ...
        <div class="flex items-start ">
            <div class="flex flex-col flex-shrink-0 space-y-2">
                <span class="text-sbtext">Sessions</span>
    ...
    <!-- Vists chart card --><a href="#"
        ...
        <div class="flex items-start">
            <div class="flex flex-col flex-shrink-0 space-y-2">
                <span class="text-navtext">Vists</span>
    ...
    <!-- Articles chart card --><a href="#"
        ...
        <div class="flex items-start">
            <div class="flex flex-col flex-shrink-0 space-y-2">
                <span class="text-contenttext">Articles</span>
...
<div class="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2 lg:grid-cols-4">
    <!-- Users chart card --><a href="#"
        ...
        <div class="flex items-start ">
            <div class="flex flex-col flex-shrink-0 space-y-2">
                <span class="text-skin-titel">Total Users</span>
                <span class="text-skin-sub-titel text-lg font-semibold">100,221</span>
            </div>
            <div class="relative min-w-0 ml-auto h-14">
                <canvas id="usersChart"></canvas>
            </div>
        ...
        <div>
            ...
            <span class="text-skin-paragraph">from 2020</span>
        </div>
    </a>
...
<div class="grid grid-cols-1 gap-6 mt-6 lg:grid-cols-2 xl:grid-cols-4">
    <!-- Import data card -->
    <div class="bg-skin-contentbody-fill  rounded-lg shadow-sm">
        <!-- Card header -->
        <div class="bg-skin-contenthead-fill flex items-center justify-between px-4 py-2">
            <h5 class="font-semibold text-skin-titel">Import Data</h5>
            <!-- Dots button -->
            <button class="p-2 rounded-full">
                <svg class="w-6 h-6 text-contenttext" xmlns="http://www.w3.org/2000/svg" fill="none"
        ...
        <p class="px-4 py-6 text-skin-paragraph">See and talk to your users and import them into your
            platform.</p>
        <ul class="px-4 pb-4 space-y-4 divide-y">
            <h5 class="text-skin-sub-titel font-semibold">Import Users from:</h5>
...
=======
    ...
    <!-- Statistics Cards -->
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4" :class="{'lg:grid-cols-6':!open}">
        <div class="bg-smil1 text-smid1 shadow-xl rounded-md flex items-center justify-between p-3  border-b-4 border-red-600 dark:border-gray-600  font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-gray-200  rounded-full transition-all duration-300 transform group-hover:rotate-12">
                <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="stroke-current text-gray-900  dark:text-gray-800 transform transition-transform duration-500 ease-in-out">
        ...
        <div class="bg-smil2 text-smid2 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600  font-medium group">
        ...
        <div class="bg-smil3 text-smid3 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-col4 dark:border-gray-600  font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="stroke-current text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out">
        ...
        <div class="bg-smid1 text-smil1 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-col3 dark:border-gray-600 font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="stroke-current text-smibr  transform transition-transform duration-500 ease-in-out">
        ...
        <div class="bg-smid2  text-smil2 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600  font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="stroke-current text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                    </path>
        ...
        <div class="bg-smid3 text-smil3 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600  font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="stroke-current text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                    </path>
        ...
        <div class="bg-smibr shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600  font-medium group">
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="stroke-current text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z">
                    </path>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
        ...
        <!-- Social Traffic -->
        <div class="relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words bg-smicolor2 dark:bg-gray-900 w-full shadow-lg rounded">
            <div class="rounded-t mb-0 px-0 border-0">
                ...
                <div class="block w-full overflow-x-auto">
                    <table class="items-center w-full bg-transparent border-collapse">
                        <thead>
                            <tr>
                                <th class="px-4 bg-gray-100 dark:bg-gray-600 text-gray-50 dark:text-gray-100 align-middle border border-solid border-gray-200 dark:border-stone-500 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">
                                    Referral</th>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div class="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                                                <div style="width: 70%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-600">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr class="text-gray-700 dark:text-gray-100">
                                ...
                                <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div class="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                                                <div style="width: 40%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div class="overflow-hidden h-2 text-xs flex rounded bg-pink-200">
                                                <div style="width: 45%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-pink-500">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr class="text-gray-700 dark:text-gray-100">
                                ...
                                <td class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div class="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                                                <div style="width: 30%" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-700">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- Recent Activities -->
        <div class="relative flex flex-col min-w-0 break-words bg-gray-50 dark:bg-gray-900 w-full shadow-lg rounded">
            <div class="rounded-t mb-0 px-0 border-0">
                <div class="flex flex-wrap items-center px-4 py-2">
                    <div class="relative w-full max-w-full flex-grow flex-1">
...
<<<<<<< HEAD
                <a href="#"
                    class="flex items-center px-2 py-1 space-x-2 text-sm text-skin-btnprimary bg-skin-btnprimary-fill opacity-100 hover:opacity-80 rounded-md">
                    <span>Launch</span>
                    <span class="">
...
<div class="flex flex-col mt-6">
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <div class="overflow-hidden  border-gray-200 rounded-md shadow-md">
                <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                    <thead class="bg-skin-contenthead-fill">
                        <tr>
                            <th scope="col"
                                class="px-6 py-3 text-xs font-semibold tracking-wider text-left text-skin-titel uppercase">
                                Name
                            </th>
                            <th scope="col"
                                class="px-6 py-3 text-xs font-semibold tracking-wider text-left text-skin-titel uppercase">
                    ...
                    <tbody class=" divide-y divide-gray-200 bg-skin-contentbody-fill">
                            ...
                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-skin-titel">Ahmed
                                                Kamel
                                            </div>
                                            <div class="text-sm text-skin-paragraph">
