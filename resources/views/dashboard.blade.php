...
@section('title','Dashboard')
        ...
        :class="{'lg:grid-cols-6':!open}">
            <div
                class="draklightbg1 draklighttext  shadow-xl rounded-md flex items-center justify-between p-3  border-b-4 border-red-600 dark:border-gray-600  font-medium group">
                <div
                    class="flex justify-center items-center w-14 h-14 bg-gray-200  rounded-full transition-all duration-300 transform group-hover:rotate-12">
                    <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        class="stroke-current text-gray-900  dark:text-gray-800 transform transition-transform duration-500 ease-in-out">
            ...
            <div
                class="draklightbg1 draklighttext shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600  font-medium group">
                <div
            ...
            <div
                class="draklightbg1 draklighttext shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-col4 dark:border-gray-600  font-medium group">
                <div
                    class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                    <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        class="stroke-current text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out">
            ...
            <div
                class="draklightbg1 draklighttext shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-col3 dark:border-gray-600 font-medium group">
                <div
                    class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                    <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        class="stroke-current text-blue-800 dark:text-gray-800 transform transition-transform duration-500 ease-in-out">
