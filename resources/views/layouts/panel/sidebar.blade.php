<div x-show="open" class="fixed flex flex-col top-14 left-0 w-14 md:w-64 hover:w-64  bg-blue-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10">
